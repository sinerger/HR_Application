...
namespace HR_Application_BLL.Mappers
{
    public class CustomMapperProfile : Profile
    {
        public CustomMapperProfile()
        {
            ...
            CreateMap<Adress, LocationDTO>()
                .ForMember(dest => dest.CityID, option => option.MapFrom(source => source.City.ID))
            ...
            CreateMap<Position, EmployeePositionDTO>()
                .ForMember(dest => dest.PositionID, option => option.MapFrom(source => source.Post.ID))
            ...
            CreateMap<ProjectModel, ProjectDTO>()
                .ForMember(dest => dest.DirectionID, option => option.MapFrom(source => 1));
            ...
            CreateMap<Competence, EmployeeSkillDTO>()
                .ForMember(dest => dest.SkillID, option => option.MapFrom(source => source.Skill.ID))
